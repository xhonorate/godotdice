...
for suite in ["test_dice.gd", "test_dice_shapes.gd", "test_stones.gd", "test_battle.gd", "test_enemy_turns.gd", "test_enemy_ui.gd", "test_descent.gd", "test_net.gd", "test_view.gd", "test_creatures.gd", "test_audio.gd", "test_screens.gd", "test_fit.gd"]:
