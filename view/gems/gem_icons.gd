...
const HINTS := {
	"carat": "Carat: how much. One multiplier over everything the stone does.",
	"clarity": "Clarity: how pure. Flawless stones hit harder and are judged a Cut step better; included stones carry inclusions instead.",
